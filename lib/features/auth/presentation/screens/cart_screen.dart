        ...
        children: [
          ...
          SizedBox(
            ...
            child: Container(
              ...
              child: const Center(
                child: Text(
                  'Cart',
                  style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 164, 104, 13)),
                ),
              ),
            ),
          ),
          ...
          Container(
            ...
            decoration: BoxDecoration(color: Colors.grey.withOpacity(0.5), boxShadow: [
              BoxShadow(color: Colors.grey.withOpacity(0.5), blurRadius: 2, offset: const Offset(0, 3)),
            ]),
          ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(fontSize: 14, color: Color.fromARGB(255, 71, 71, 71)),
                          overflow: TextOverflow.ellipsis,
                        ),
                      ],
                    ),
                  ),
                  const Icon(Icons.arrow_forward_ios, size: 20, color: Colors.deepOrange),
                ],
              ),
            ),
          ),
          ...
          const Padding(
            ...
            child: Align(
              ...
              child: Text('Items in your cart', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            ),
          ),
